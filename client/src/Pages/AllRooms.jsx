...
const AllRooms = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row  items-start  justify-between pt-25 md:pt-30 px-4 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-col items-start text-left">
        ...
        {filteredRooms.length == 0 && (
          <div className="text-center mt-4 text-3xl font-semibold text-gray-400 flex h-full w-full items-center justify-start ">
            Sorry, we couldn’t find any hotels in this location.
          </div>
        )}
        {filteredRooms.length > 0 &&
